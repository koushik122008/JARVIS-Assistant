    ...
    def check(self) -> str | None:
        ...
        if cpu >= self.thresholds["cpu"]:
            ...
            if self._cpu_streak >= _CPU_STREAK and self._can_alert("cpu"):
                alerts.append(
                    ...
                    "for several seconds. Warn the user in English (or the language they explicitly requested) and suggest "
        ...
        if ram >= self.thresholds["ram"] and self._can_alert("ram"):
            alerts.append(
                ...
                "Warn the user in English (or the language they explicitly requested) and suggest freeing memory."
            )
            self._record("ram")
        ...
        if temp > 0 and temp >= self.thresholds["temp"] and self._can_alert("temp"):
            alerts.append(
                ...
                "Warn the user in English (or the language they explicitly requested) and advise reducing system load "
                "or checking cooling."
            )
            self._record("temp")
        ...
        if gpu >= 0 and gpu >= self.thresholds["gpu"] and self._can_alert("gpu"):
            alerts.append(
                ...
                "Briefly inform the user in English (or the language they explicitly requested)."
            )
            self._record("gpu")

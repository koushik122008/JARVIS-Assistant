...
from utils import (
    ...
    get_api_key, LIVE_MODEL as _LIVE_MODEL,
    CHANNELS as _CHANNELS,
    RECEIVE_SAMPLE_RATE as _RECEIVE_SAMPLE_RATE,
    CHUNK_SIZE as _CHUNK_SIZE,
    IMG_MAX_W, IMG_MAX_H, JPEG_Q,
)
...
_SYSTEM_PROMPT = (
    ...
    "Address the user as 'sir' by default (only adapt if the user explicitly requested another language)."
)

...
def _build_google_flights_url(
    ...
    # NOTE: a stale hardcoded tfs (travel-flights-spec) token was removed here —
    # it encoded a fixed IST→LHR flight from March 2025 and silently broke every
    # search. Google Flights prefills correctly from the q= parameter alone.
    return (
        f"{base}"
        f"?q={trip}"
        f"&curr=USD"

...
## 🍓 Raspberry Pi 5 (Local Voice Unit)

A fully local voice-assistant starter for the Raspberry Pi 5 lives in
[`pi5/`](pi5/README.md) — wake word (openWakeWord) → Whisper (STT) → Ollama
local LLM with tool calling → Kokoro TTS. No cloud, no API keys.
